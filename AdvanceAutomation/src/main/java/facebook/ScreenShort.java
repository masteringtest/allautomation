...
public class ScreenShort {
	public static void main(String[] args) throws InterruptedException, IOException {
	    ...
	    Thread.sleep(2000);
		//driver.findElement(By.xpath("//div[@role=\"navigation\"]/div/div/div/div/div/div[1]/ul/li/div")).click();
	    
	   // WebElement web = driver.findElement(By.xpath("//div[@role=\"navigation\"]"));
	    
	    WebElement web = driver.findElement(By.xpath("//div[@role='navigation']/div[1]"));
	    		
	    System.out.println("ScreenShort.main()"+web.getTagName());
	    System.out.println("ScreenShort.main()"+web.getText());
